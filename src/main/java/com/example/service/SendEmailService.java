...
public class SendEmailService {
    ...
    public int sendEmailTempPassword(String userEmail, String userName){
        String str = getTempPassword();
        updatePassword(str,userEmail);
        // MailDto dto = new MailDto();
        // dto.setAddress(userEmail);
        // dto.setTitle(userName+"님의 Travel 임시비밀번호 안내 이메일 입니다.");
        // dto.setMessage("안녕하세요. Travel 임시비밀번호 안내 관련 이메일 입니다." + "[" + userName + "]" +"님의 임시 비밀번호는 "
        // + str + " 입니다.");
        ...
        message.setText("안녕하세요. Travel 임시비밀번호 안내 관련 이메일 입니다." + "[" + userName + "]" +"님의 임시 비밀번호는 "
        + str + " 입니다.");
