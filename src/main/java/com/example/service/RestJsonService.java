...
public class RestJsonService {
    ...
    private final String KAKAO_REDIRECT_URI = "http://ibyeong.shop/login";
    ...
    private final String NAVER_REDIRECT_URI = "http://ibyeong.shop/login";
    ...
    private final String GOOGLE_REDIRECT_URI = "http://ibyeong.shop/login";
